...
class SimulationManager:
    def __init__(
        self, pCreation=True, iCoordination=True, iZipping=True, maxVehiclesPerPlatoon=0
    ):
        self.intersections = []
        self.platoons = list()
        ...
        if self.platoons:
            ...
            for platoon in self.platoons:
                if (
                    ...
                    and platoon._disbandReason != "Reform required due to new leader"
                ):
    ...
    def getReleventPlatoon(self, vehicle):
        ...
        if leadVeh and leadVeh[1] < 10:
            ...
            if possiblePlatoon:
                if (
                    possiblePlatoon[0].checkVehiclePathsConverge([vehicle])
                    and vehicle not in possiblePlatoon[0].getAllVehicles()
                    and possiblePlatoon[0].canAddVehicles([vehicle])
                ):
    ...
    def handleSimulationStep(self):
        ...
        if self.platoonCreation:
            ...
            vehiclesNotInPlatoons = [
                v for v in allVehicles if v not in self.getAllVehiclesInPlatoons()
            ]
            ...
            for platoon in self.getActivePlatoons():
                ...
                if platoon.canMerge() and platoon.isActive():
                    ...
                    if lead:
                        ...
                        if leadPlatoon and leadPlatoon[0].canAddVehicles(
                            platoon._vehicles
                        ):
